def photsys():
        ...
        WAVE['GaiaDR3_G']  = [6217.59,4052.97,3228.75,'+','C2']
        WAVE['GaiaDR3_BP'] = [5109.71,2157.50,3552.01,'+','C2']
        WAVE['GaiaDR3_RP'] = [7769.02,2924.44,2554.95,'+','C2']
        ...
        WAVE['UKIDSS_J'] = [12483.00,1590.00,2250.67,'d','C5']
...
def filtercurves():
        ...
        import uberMS
        cpath = uberMS.__abspath__

        FC = {}
        for ff in photsys().keys():
                try:
                        FC[ff] = np.loadtxt(f'{cpath}/uberMS/utils/filtercurves/{ff}.fc',dtype=[('wave',float),('trans',float)])
                except:
                        FC[ff] = {'wave':[],'trans':[]}
        return FC